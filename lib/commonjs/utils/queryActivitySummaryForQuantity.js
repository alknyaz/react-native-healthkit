...
const queryActivitySummaryForQuantity = async options => {
  ...
  console.log("preffered units:", JSON.stringify(await _nativeTypes.default.getPreferredUnits([_nativeTypes.HKQuantityTypeIdentifier.activeEnergyBurned, _nativeTypes.HKQuantityTypeIdentifier.appleMoveTime]), undefined, 2));
