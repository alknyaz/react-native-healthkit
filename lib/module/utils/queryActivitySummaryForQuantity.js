...
const queryActivitySummaryForQuantity = async options => {
  ...
  console.log("preffered units:", JSON.stringify(await Native.getPreferredUnits([HKQuantityTypeIdentifier.activeEnergyBurned, HKQuantityTypeIdentifier.appleMoveTime]), undefined, 2));
